...
export function WorkoutProgression({ state, setState }: { state: AppState; setState: React.Dispatch<React.SetStateAction<AppState>> }) {
  ...
  return <section className="personal-panel wide" data-widget-id="progress-load-v2"><h3>Recordes e progressão de carga</h3><p>O último treino é a referência de carga e repetições. Podes ajustar cada série durante o treino; não aumentamos a carga automaticamente.</p>
