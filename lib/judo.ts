...
export const judoTechniques: JudoTechnique[] = [
  ...
  technique('sukui-nage', 'Sukui-nage', '掬投', 'Te-waza', ''),
  technique('uki-otoshi', 'Uki-otoshi', '浮落', 'Te-waza', ''),
  ...
  technique('hane-goshi', 'Hane-goshi', '跳腰', 'Koshi-waza', ''),
  technique('ushiro-goshi', 'Ushiro-goshi', '後腰', 'Koshi-waza', ''),
  ...
  technique('ko-soto-gari', 'Ko-soto-gari', '小外刈', 'Ashi-waza', ''),
  technique('ko-soto-gake', 'Ko-soto-gake', '小外掛', 'Ashi-waza', ''),
  technique('ashi-guruma', 'Ashi-guruma', '足車', 'Ashi-waza', ''),
  technique('harai-tsurikomi-ashi', 'Harai-tsurikomi-ashi', '払釣込足', 'Ashi-waza', ''),
  technique('o-guruma', 'O-guruma', '大車', 'Ashi-waza', ''),
  technique('o-soto-guruma', 'O-soto-guruma', '大外車', 'Ashi-waza', ''),
  ...
  technique('hane-makikomi', 'Hane-makikomi', '跳巻込', 'Sutemi-waza', ''),
  technique('soto-makikomi', 'Soto-makikomi', '外巻込', 'Sutemi-waza', ''),
  technique('uki-waza', 'Uki-waza', '浮技', 'Sutemi-waza', ''),
  technique('yoko-wakare', 'Yoko-wakare', '横分', 'Sutemi-waza', ''),
  technique('yoko-guruma', 'Yoko-guruma', '横車', 'Sutemi-waza', ''),
  technique('yoko-gake', 'Yoko-gake', '横掛', 'Sutemi-waza', ''),
