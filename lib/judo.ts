...
export const judoTechniques: JudoTechnique[] = [
  ...
  technique('sukui-nage', 'Sukui-nage', '掬投', 'Te-waza', 'vU6aJ2kFxoI'),
  technique('uki-otoshi', 'Uki-otoshi', '浮落', 'Te-waza', '6H5tmncOY4Q'),
  technique('uki-goshi', 'Uki-goshi', '浮腰', 'Koshi-waza', 'bPKwtB4lyOQ'),
  technique('o-goshi', 'O-goshi', '大腰', 'Koshi-waza', 'yhu1mfy2vJ4'),
  technique('koshi-guruma', 'Koshi-guruma', '腰車', 'Koshi-waza', 'SU7Id6uVJ44'),
  ...
  technique('tsuri-goshi', 'Tsuri-goshi', '釣腰', 'Koshi-waza', 'KlaL5U0CIgI'),
  technique('hane-goshi', 'Hane-goshi', '跳腰', 'Koshi-waza', 'M9_7De6A1kk'),
  technique('ushiro-goshi', 'Ushiro-goshi', '後腰', 'Koshi-waza', 'ORIYstuxYT8'),
  ...
  technique('hiza-guruma', 'Hiza-guruma', '膝車', 'Ashi-waza', 'JPJx9-oAVns'),
  ...
  technique('ko-soto-gari', 'Ko-soto-gari', '小外刈', 'Ashi-waza', 'jeQ541ScLB4'),
  technique('ko-soto-gake', 'Ko-soto-gake', '小外掛', 'Ashi-waza', '8b6kY4s4zH4'),
  technique('ashi-guruma', 'Ashi-guruma', '足車', 'Ashi-waza', 'ROeayhvom9U'),
  technique('harai-tsurikomi-ashi', 'Harai-tsurikomi-ashi', '払釣込足', 'Ashi-waza', 'gGPXvWL8VbE'),
  technique('o-guruma', 'O-guruma', '大車', 'Ashi-waza', 'SnZciTAY9vc'),
  technique('o-soto-guruma', 'O-soto-guruma', '大外車', 'Ashi-waza', '92KbCm6pQeI'),
  ...
  technique('hane-makikomi', 'Hane-makikomi', '跳巻込', 'Sutemi-waza', '6CRBGLGz9j8'),
  technique('soto-makikomi', 'Soto-makikomi', '外巻込', 'Sutemi-waza', 'bWG9O1BVKtQ'),
  technique('uki-waza', 'Uki-waza', '浮技', 'Sutemi-waza', 'weVOpJ63gII'),
  technique('yoko-wakare', 'Yoko-wakare', '横分', 'Sutemi-waza', 'bp1tscHlePI'),
  technique('yoko-guruma', 'Yoko-guruma', '横車', 'Sutemi-waza', 'MehP6I5cY2c'),
  technique('yoko-gake', 'Yoko-gake', '横掛', 'Sutemi-waza', 'tP1Sj1uDfSo'),
